...
import com.example.backendforroomresq1.dto.AuthResponse;
import com.example.backendforroomresq1.dto.LoginRequest;
import com.example.backendforroomresq1.dto.VerificationRequest;
...
public class AuthService {
    ...
    public AuthResponse registerVerified(VerificationRequest request) {
        ...
        return new AuthResponse(accessToken, refreshToken, user.getId(), user.getEmail(),user.getName(),user.getRoles(),user.getRoomno());
    }
    ...
    public User registerUser(String email, String password, String name, Set<Role> roles, String roomno) {
